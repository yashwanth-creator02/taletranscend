...
export function initTheme() {
  ...
  // Nine of the twelve families in the picker had no stylesheet behind them
  // and silently rendered as Georgia. This loads every declared family.
  loadReaderFontStylesheets();
