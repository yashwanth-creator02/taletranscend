/**
 * Generates HTML for a single tale card.
 *
 * @param {Object} tale - Tale metadata object
 * @param {Object} readTimeMap - Optional map of taleId → total read time in ms
...
export function createTaleCard(tale, readTimeMap = {}) {
  ...
  // Compute time in minutes and clamp progress
  ...
  return `
    <div class="glass-panel group relative p-5 rounded-[2.5rem] hover:border-indigo-500/40 transition-all cursor-pointer tale-card-glow overflow-visible" data-id="${id}">
        ...
        <!-- CONTENT: Title, description, chapters, time, resume -->
        <div class="px-2">
